...
{
    /// <summary>
    /// Request to delete a file from storage server.
    /// Command: STORAGE_PROTO_CMD_DELETE_FILE (12)
    /// Request body structure:
    /// - Group name (16 bytes)
    /// - File name (variable length)
    /// </summary>
    public class DeleteFileRequest : FastDFSRequest<DeleteFileResponse>
    {
        /// <summary>
        ...
        /// </summary>
        public override byte Command => StorageCommand.DeleteFile;
