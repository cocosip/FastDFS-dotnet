...
{
    /// <summary>
    /// Request to query all available storage servers for download.
    /// The tracker will return all storage servers that have the file.
    /// Command: TRACKER_PROTO_CMD_SERVICE_QUERY_FETCH_ALL (107)
    /// Request body structure:
    /// - Group name (16 bytes)
    /// - File name (variable length)
    /// </summary>
    public class QueryFetchAllRequest : FastDFSRequest<QueryFetchAllResponse>
    {
        /// <summary>
        ...
        /// </summary>
        public override byte Command => TrackerCommand.QueryFetchAll;
